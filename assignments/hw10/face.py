...
class Face:
    ...
    def smile(self):
        smile = Polygon(self.mouth.getP1(), self.mouth.getP2(), Point(self.mouth.getCenter().getX(), self.mouth.getCenter().getY() + 20))
        smile.draw(self.window)


    def shock(self):
        self.mouth.undraw()
        shockmouth = Circle(self.mouth.getCenter(), 20)
        shockmouth.draw(self.window)
